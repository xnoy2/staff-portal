            ...
            >
                ...
                <div class="flex items-center justify-between">
                    ...
                    <div v-if="isManager && entry.status === 'pending'" class="flex gap-1.5">
                        <button @click="approve(entry.id)" class="text-xs bg-green-100 text-green-700 hover:bg-green-200 px-3 py-1.5 rounded-lg transition-colors font-medium">
                            Approve
                        </button>
                        <button @click="openReject(entry)" class="text-xs bg-red-100 text-red-700 hover:bg-red-200 px-3 py-1.5 rounded-lg transition-colors font-medium">
                            Reject
                        </button>
                    </div>
                ...
                <table class="w-full text-sm">
                    ...
                    <tbody class="divide-y divide-gray-100">
                        <tr v-if="entries.data.length === 0">
                            <td :colspan="isManager ? 9 : (isPrivileged ? 8 : 7)" class="px-4 py-12 text-center text-gray-400 text-sm">No entries found.</td>
                        </tr>
                        <tr
                            v-for="entry in entries.data"
                            :key="entry.id"
                        ...
                        >
                            ...
                            <td class="px-4 py-3 text-gray-600">
                                ...
                                <span v-else-if="!entry.clock_out" class="text-green-600 font-medium">In progress</span>
                                <span v-else>—</span>
